...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        //        RoleServiceImpl roleServiceImpl = new RoleServiceImpl(); // Tight loose
//        // Spring boot does not like "New" keyword! Just let it do it!
//        roleServiceImpl.save(adminRole);
//        roleServiceImpl.save(managerRole);
//        roleServiceImpl.save(employeeRole);
//
